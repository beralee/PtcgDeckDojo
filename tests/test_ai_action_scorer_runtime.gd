...
func test_ai_opponent_only_applies_action_scorer_to_supported_kinds() -> String:
	...
	var unsupported_score: float = float(ai.call("_score_action_with_action_scorer", "play_basic_to_bench", [0.1, 0.2], {
		"action_vector": [0.3, 0.4],
	}))
	return run_checks([
